...
## Project Structure
    ...
    ├── fancy_resonance_dev_67895  # Django project configurations
...
1. Clone this repo and `cd fancy_resonance_dev_67895`
...
2. Clone this repo and `cd fancy_resonance_dev_67895`
